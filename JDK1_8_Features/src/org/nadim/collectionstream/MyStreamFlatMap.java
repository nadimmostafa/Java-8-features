...
public class MyStreamFlatMap {
	...
	public static void main(String[] args) {
		...
		//l3.forEach(l4-> l4.forEach(item->System.out.println(item)));
		...
		List<String> l6 = l3.stream().flatMap(List::stream).collect(Collectors.toList());
		//System.out.println(l6);
		
		
		//Debugging using Peek() method
		List<String> l7 = l3.stream()
				.peek(p->System.out.println("Before Processing: "+p))
				.flatMap(l4->l4.stream()).peek(s->System.out.println("After "+s)).collect(Collectors.toList());;
